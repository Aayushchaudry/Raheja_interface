...
const WALKTHROUGH_SRC = "/assets/4k_web.mp4";

const ARCH_SLIDES = [
  {
    image: "/assets/AVANA1.jpg",
...
const FEATURES = [
  ...
  },
  {
    ...
    video: "/assets/Raheja Avana 11-06-26_compressed.mp4",
  },
];
...
export default function ProjectDetailSection({ onOpenMedia, onNavigate }) {
  ...
  return (
    <section id="avana" className="avana-page">
      ...
      <div className="avana-hero" style={{ backgroundImage: `url("/assets/avana.jpg")` }}>
        <div className="avana-hero-brand">
          <p className="avana-hero-eyebrow">Raipur's First Luxury Address</p>
          <img className="avana-hero-logo" src="/assets/avanalogo.png" alt="Avana" />
